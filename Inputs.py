...
class HSREnvironment:
    ...
    def check_pixel_color(self, x, y, target_color, threshold=30):
    ...
    def get_screen_state(self):
        ...
        state = {
            'ult_1_ready': self.check_pixel_color(375, 1141, (255, 166, 132)),  # Firefly Ult Ready
            'ult_2_ready': self.check_pixel_color(711, 1231, (220, 76, 64)),  # Fugue Ult Ready
            'ult_3_ready': self.check_pixel_color(1013, 1231, (255, 248, 129)),  # Fugue Ult Ready
            'ult_4_ready': self.check_pixel_color(1314, 1231, (117, 244, 255)),  # Ruan Mei Ult Ready
            ...
            'superbreak_stacks': self.check_pixel_color(860, 1266, (254, 253, 214)), # TB stacks
            'rm_skill_stacks': self.check_pixel_color(1163, 1265, (220, 250, 255)), # RM stacks
            'fugue_stacks': self.check_pixel_color(559, 1266, (255, 225, 228)), # Fugue stacks
            ...
            'firefly_turn': self.check_pixel_color(436, 1122, (11, 9, 6)),
        }
        return state
...
def main():
    ...
    try:
        while True:
            env.check_coordinates(860, 1266)  
            env.check_coordinates(1163, 1265) 
            env.check_coordinates(559, 1266)
            state = env.get_screen_state()
